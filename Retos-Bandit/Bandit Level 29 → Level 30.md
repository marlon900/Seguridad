...
## Objetivo
Hay un repositorio git en via the port . La contraseña para el usuario es la misma que para el usuario.`ssh://bandit29-git@localhost/home/bandit29-git/repo``2220``bandit29-git``bandit29`
